...
class HexLinkTest(unittest.TestCase):
    def setUp(self):
        ...
        self.game = TriangleLink(self.field)
        self.simple_game = TriangleLink([
            [1, 2],
            [0, 0, 0],
            [1, 2]
        ])
    ...
    def test_check_field_when_all_is_ok(self):
        self.assertEqual(self.field, TriangleLink(self.field)._field)
    ...
    def test_init_when_wrong_cells(self):
        ...
        self.assertRaises(ValueError, TriangleLink, field)
    ...
    def test_init_raise_when_get_None(self):
        self.assertRaises(ValueError, TriangleLink, None)

    def test_init_raise_when_get_empty(self):
        self.assertRaises(ValueError, TriangleLink, [])
